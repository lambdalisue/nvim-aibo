...
local BUILTIN_COMMANDS = {
  ...
  { cmd = "/mobile", description = "Display QR code to download the Claude mobile app" },
  ...
  { cmd = "/rc", description = "Start a Remote Control session (alias for /remote-control)" },
  { cmd = "/release-notes", description = "View latest release notes" },
  { cmd = "/remote-control", description = "Start a Remote Control session to continue locally from another device" },
